...
from mcore_utils import init_distributed, init_mpu, patch_mcore_args
from qwen3_configuration import QWEN3_MOE_MODELS, Qwen3MCoreConfig, Qwen3ConfigT
...
def main(args: Namespace):
    ...
    qwen_config = Qwen3MCoreConfig.from_hf(hf_config)
    pprint(qwen_config)
